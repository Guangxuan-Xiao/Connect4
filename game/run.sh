g++ -Wall -std=c++11 -O0 -fpic -shared -DDEBUG -D OUTPUT -g -rdynamic ./Strategy/Judge.cpp ./Strategy/Strategy.cpp ./Strategy/MCTree.cpp ./Strategy/Phase.hpp -o ./so/Strategy.so
